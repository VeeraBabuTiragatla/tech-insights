---
layout: default
title: "The Machine Can Recommend. The Architecture Must Answer."
permalink: /the-machine-can-recommend-the-architecture-must-answer/
...
<figure class="article-figure article-figure-wide">
  ...
  <figcaption>Enterprise AI recommendations become serious when they pass through authority, action and learning loops. Architecture decides where those boundaries sit.</figcaption>
</figure>
...
- Is the financial exposure small or material?
- Could the recommendation affect a person’s opportunity, reputation or rights?
- Does the user understand the trade-off being made?
- Would a delay create operational risk?
- Has this pattern earned more autonomy through reliable outcomes?
...
- **Consequence:** What harm, cost, unfairness or operational exposure could follow if the recommendation is wrong?
- **Reversibility:** How easily can the organisation undo the action after it is taken?
...
- Which policy or threshold shaped the answer?
- Which model, prompt, retrieval source or tool call was involved?
- Which role was permitted to see the output?
- What authority did the output possess?
- Could the user challenge or override it?
- What happened after the recommendation was followed?
...
- Did the system include supplier concentration risk?
- Did it check whether Supplier A is already overrepresented in critical categories?
- Did it include sustainability and compliance status?
- Did it examine regional disruption risk?
- Did it know whether the component supports a regulated product or a customer-critical commitment?
- Did it consider contract terms and exit flexibility?
- Did it show whether the recommendation is advisory or approval-ready?
- Did it require a human approver because the decision crosses a value threshold?
- Did it record why the recommendation was accepted or rejected?
...
- Where does evidence become interpretation?
- Where does interpretation become recommendation?
- Where does recommendation become permission?
- Where does permission become action?
- Where does action become learning?
...
**Further context:** This essay is original commentary shaped by practical enterprise architecture and data experience. It also sits within a broader industry movement: [SAP](https://help.sap.com/docs/JOULE/3fdd7b321eb24d1b9d40605dce822e84) is embedding AI assistants and agents into business workflows, [Microsoft Fabric](https://learn.microsoft.com/en-us/fabric/data-science/concept-data-agent) is making governed data more conversational through data agents, and AI risk frameworks such as the [NIST AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework) and [OECD AI Principles](https://www.oecd.org/en/topics/ai-principles.html) increasingly emphasise human oversight, accountability, transparency and traceability. The argument here is that enterprise architecture must now decide not only how information moves, but how machine-generated authority is bounded.
