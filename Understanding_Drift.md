...
<figure class="article-figure article-figure-wide">
  <img src="/assets/images/machine-can-recommend-architecture-must-answer.png" alt="A bright enterprise architecture visual showing context, recommendation, authority, decision and feedback loops">
...
<figure class="article-figure">
  <img src="/assets/images/machine-can-recommend-architecture-must-answer-og.png" alt="A compact enterprise AI governance visual showing the flow from data and context to recommendation, authority and learning">
  <figcaption>When machine recommendations move closer to action, human judgement has to stay active in the loop.</figcaption>
</figure>
...
- framing the problem before generating solutions
- questioning assumptions rather than accepting the first explanation
- maintaining contact with original evidence rather than relying only on summaries
- independently synthesising ideas before refining them with AI
- exercising judgement when evidence is incomplete or uncertain
- reflecting on outcomes so that future decisions become wiser than previous ones
